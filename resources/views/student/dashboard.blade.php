            ...
            @elseif(!$hasHasil)
                <div class="mt-7 flex flex-wrap gap-3">
                    <form method="POST" action="{{ route('student.hasil.index') }}" class="inline">
                        @csrf
                        <button type="submit" class="inline-flex items-center gap-2 px-5 py-2.5 rounded-lg bg-blue-600 text-white text-sm font-medium hover:bg-blue-700 transition shadow-sm">
