     ...
     <div class="max-w-6xl mx-auto px-6 py-3 flex items-center justify-between">
         ...
         <div class="hidden md:flex items-center gap-6">
             <a href="{{ auth()->check() ? route('student.dashboard') : route('welcome') }}"
                 class="text-sm text-gray-500 hover:text-gray-800 transition">Tentang</a>
             <a href="{{ route('student.nilai.index') }}" class="text-sm text-gray-500 hover:text-gray-800 transition">Dashboard</a>
